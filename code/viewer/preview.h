...
#define	TEXTURE_NUMBER_1		6
#define	TEXTURE_NUMBER_2		7
#define	TEXTURE_NUMBER_3		8
#define	TEXTURE_NUMBER_4		9
#define	TEXTURE_NO_CAMERA		10
#define	TEXTURE_NO_CAMERA		10
#define LAST_TEXTURE			11
...
private:
	...
	void ScalePolygon(ScreenPoint * input, ScreenPoint * output, int numPoints, float scale);
	...
	QImage imgConnectionMessage, imgNoCassapa, imgNoCamera;
	QImage imgNumb1, imgNumb2, imgNumb3, imgNumb4;
	...
	int projDragX, projDragY, projDragId;
	ScreenPoint minorProjectorLimits[4];
